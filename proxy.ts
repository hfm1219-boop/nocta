...
export const config = {
  matcher: ["/super/:path*", "/admin/:path*", "/promotor/:path*", "/acceso/:path*", "/accesos/:path*", "/reservas/:path*", "/barra/:path*", "/mesero/:path*", "/dj/:path*", "/mis-entradas/:path*", "/mis-reservas/:path*", "/mi-nocta/:path*"],
};
